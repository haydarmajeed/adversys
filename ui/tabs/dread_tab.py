...
from dread import create_dread_assessment_prompt, get_dread_assessment, get_dread_assessment_azure, get_dread_assessment_google, dread_json_to_markdown
                ...
                while retry_count < max_retries:
                    try:
                        ...
                        if model_provider == "Azure OpenAI Service":
                            azure_api_endpoint = st.session_state.get('azure_api_endpoint_tab')
                            azure_api_key = st.session_state.get('azure_api_key_tab')
                            azure_api_version = '2023-12-01-preview'
                            azure_deployment_name = st.session_state.get('azure_deployment_name_tab')
